...
export default function Terminos() {
  return (
    <div className="bg-blue-50 min-h-screen flex items-center justify-center">
      ...
      <h3 className="mt-6 font-semibold text-lg">1. Aceptación</h3>
      ...
      <h3 className="mt-6 font-semibold text-lg">2. Modelo de Servicio y Uso de la Plataforma</h3>
      ...
      <h3 className="mt-6 font-semibold text-lg">3. No Custodia, No Entidad Financiera</h3>
      ...
      <h3 className="mt-6 font-semibold text-lg">4. Pagos y CLABE</h3>
      ...
      <h3 className="mt-6 font-semibold text-lg">5. Escrow y Limitación de Responsabilidad</h3>
      ...
      <h3 className="mt-6 font-semibold text-lg">6. Privacidad</h3>
      <p>Consulta nuestro <Link href="/privacidad" className="underline text-indigo-700">Aviso de Privacidad</Link> para conocer cómo protegemos tus datos personales.</p>
      <h3 className="mt-6 font-semibold text-lg">7. Modificaciones</h3>
      ...
      <h3 className="mt-6 font-semibold text-lg">8. Legislación Aplicable</h3>
