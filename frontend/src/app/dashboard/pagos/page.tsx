  ...
  return (
    <div className="px-2 pt-4 pb-16 sm:px-4 md:px-8">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-4 gap-2 sm:gap-0">
        ...
        <Link href="/dashboard/pagos/nuevo" className="w-full sm:w-auto bg-primary text-black rounded px-4 py-2 font-semibold shadow hover:bg-primary-dark transition text-center">Nuevo pago estándar</Link>
      </div>
