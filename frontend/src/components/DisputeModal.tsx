    ...
    <div className="modal-overlay">
      <div className="modal-content">
        ...
        <style>{`
          ...
          .modal-submit {
            width: 100%; background: #F57C00; color: #fff; border: none; border-radius: 24px; padding: 14px 0; font-size: 18px; font-weight: 600; font-family: 'Montserrat', Arial, sans-serif; margin-top: auto; box-shadow: 0 1px 4px #E3EAFD; cursor: pointer; transition: background 0.2s;
          }
          .modal-submit:hover {
            background: #E65100;
          }
