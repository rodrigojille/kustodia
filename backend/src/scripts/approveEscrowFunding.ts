...
async function main() {
  ...
  console.log('Saldo MXNB:', ethers.formatUnits(balance, 18));
  ...
  console.log('Allowance actual:', ethers.formatUnits(currentAllowance, 18));
  // Forzar approve por el monto requerido, sin importar allowance previo
  console.log(`Aprobando ${ethers.formatUnits(AMOUNT, 6)} MXNB para el contrato de escrow...`);
