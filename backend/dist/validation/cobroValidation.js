...
exports.validateCobroPayment = exports.validateUniqueBrokerEmails = exports.validateCommissionSplits = exports.validateCobroPaymentData = exports.validateCommissionRecipient = void 0;
...
const validateCommissionRecipient = (recipient) => {
    const errors = [];
...
exports.validateCommissionRecipient = validateCommissionRecipient;
// Main cobro payment validation
const validateCobroPaymentData = (data) => {
    const errors = [];
    ...
    if (!Array.isArray(data.commission_recipients) || data.commission_recipients.length === 0) {
        ...
        data.commission_recipients.forEach((recipient, index) => {
            const recipientErrors = (0, exports.validateCommissionRecipient)(recipient);
...
exports.validateCobroPaymentData = validateCobroPaymentData;
// Validation for commission splits
const validateCommissionSplits = (recipients) => {
...
exports.validateCommissionSplits = validateCommissionSplits;
// Validation for unique broker emails
const validateUniqueBrokerEmails = (recipients) => {
    const emails = recipients.map((r) => r.broker_email);
...
exports.validateUniqueBrokerEmails = validateUniqueBrokerEmails;
// Combined validation for cobro payment
const validateCobroPayment = async (data) => {
    try {
        const errors = (0, exports.validateCobroPaymentData)(data);
        if (errors.length > 0) {
            return {
                isValid: false,
                errors: errors
        ...
        const commissionSplitError = (0, exports.validateCommissionSplits)(data.commission_recipients);
        ...
        const uniqueEmailError = (0, exports.validateUniqueBrokerEmails)(data.commission_recipients);
        if (uniqueEmailError) {
            return {
                isValid: false,
...
exports.validateCobroPayment = validateCobroPayment;
